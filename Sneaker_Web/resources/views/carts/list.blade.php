            ...
            <tr class="table_row">
                ...
                <td class="column-4">
                    <div class="wrap-num-product flex-w m-l-auto m-r-0">
                        ...
                        <input class="mtext-104 cl3 txt-center num-product" type="number" min="1" name="num_product[{{$product->id}}]" value="{{$carts[$product->id]}}">
                ...
                <td class="column-5 subtotal" data-price="{{$product->price * $carts[$product->id]}}">{{number_format($product->price * $carts[$product->id])}}</td>
    ...
    @endif
				...
				<div class="col-sm-10 col-lg-7 col-xl-5 m-lr-auto m-b-50">
					<div class="bor10 p-lr-40 p-t-30 p-b-40 m-l-63 m-r-40 m-lr-0-xl p-lr-15-sm">
						...
						<div class="flex-w flex-t bor12 p-t-15 p-b-30">
							<div class="size-100 p-r-18 p-r-0-sm w-full-ssm">		
								<div class="p-t-15">
									...
									<div class="bor8 bg0 m-b-22">
										<input class="stext-111 cl8 plh3 size-111 p-lr-15" type="text" name="address" placeholder="Địa chỉ nhận hàng" required>
									</div>
						...
						<button type="button" onclick="" class="flex-c-m stext-101 cl0 size-116 bg3 bor14 hov-btn3 p-lr-15 trans-04 pointer">
							Đặt hàng
						</button>
					</div>
				</div>
